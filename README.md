...
You can also use LD\_PRELOAD to heap\-profile an executable that you
...
See docs/heap\_checker.html for information about how to use tcmalloc's
...
You can also use LD\_PRELOAD to heap\-check an executable that you
...
get an error like this:
    ...
    \_\_\_tls\_get\_addr: symbol not found
